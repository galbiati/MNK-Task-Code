...
instRec = '<p class="instructions-text">You will now be shown game pieces on a board and asked to memorize their configuration. You will have 10 seconds to <b>study the configuration</b>. After a short delay, you will then be asked to <b>recreate the configuration you saw previously</b>. You will be given a score based on the number of pieces you placed correctly.</p>'
