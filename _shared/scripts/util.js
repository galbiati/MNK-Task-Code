...
instRec = '<p class="instructions-text">You will now be shown an array of black and white circles on a grey background and asked to memorize their configuration. You will have 10 seconds to <b>study the configuration</b>. After a short delay, you will then be asked to <b>recreate the configuration you saw previously</b>. You will be given a score based on the number of circles you recalled correctly.<br><br>To place a black circle on the grid, or to change a white circle to a black one, click with the left mouse button. To place a white circle on the grid, or to change a black circle to a white one, click with the right mouse button. To remove a black circle, click it with the left mouse button, and to remove a white circle, click it with the right mouse button.</p>'
